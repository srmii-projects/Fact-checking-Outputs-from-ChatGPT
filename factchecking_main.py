...
def read_passages(path: str):
    """
    Reads the retrieved passages and puts them in a dictionary mapping facts to passages.
...
def predict_two_classes(examples: List[FactExample], fact_checker):
    """
    Compares predictions against ground truth labels S and NS, ignoring IR.
    """
...
def print_eval_stats(confusion_mat, gold_label_indexer):
    """
    Prints accuracy and per-class F1 based on the confusion matrix.
    """
